...
const OwnerRegisterComponent = () => {
  ...
  return (
    <div className="w-full h-screen flex">
      {/* Left side */}
      <div className="relative p-16 flex flex-col justify-between items-start w-1/2 h-screen bg-gradient-to-r from-[#FF512F] to-[#DD2476]">
        ...
        <div className="flex flex-col grow justify-center z-20">
          ...
          <p className="text-white">
            Earn extra income and unlock new opportunities by sharing your boat
          </p>
        </div>
      </div>
      ...
      <div className="w-1/2 h-screen p-16 flex flex-col justify-between">
        ...
        <div className="grow mt-10">
          <form action="" className="space-y-6">
            <input
              className="border w-full h-12 rounded-3xl px-6 outline-red-400 hover:border-gray-700"
              name="name"
        ...
        <div className="flex justify-end">
          <button className="rounded-3xl px-8 py-2 bg-gradient-to-r from-[#FF512F] to-[#DD2476] text-white cursor-pointer">
            Register
          </button>
        </div>
      </div>
